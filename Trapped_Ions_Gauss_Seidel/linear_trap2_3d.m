%Elektrostatisches Potential in 2 Dimensionen
clc;
clear all;
close all;
...
typer='paul_lineari';
sizer=256;              %Auflösung 
iter_steps=8192*64*16;       %Iterationsschritte (in der Zeit)
dt=0.01;
omega=1;                %Frequenz der Wechselspannung
q=-0.00001;                %Ladung der Teilchen
m=0.0001;                  %Masse der Teilchen 
visc=0.9;
g_const=0.00025;              %Gravity Acceleration constant
fun=@(omega,t) cos(omega*t)+0.05;    %Voltage Signal
